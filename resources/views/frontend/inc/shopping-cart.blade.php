                    ...
                    <div class="list-cart">
                        @for($i = 0; $i < 6; $i++)
                            <div class="list-cart-item">
                                <div class="image">
                                    <img class="lazyload" data-src="{{ url('frontend/images/products/womens/women-1.jpg') }}" src="{{ url('frontend/images/products/womens/women-1.jpg') }}" alt="">
                                </div>
                                <div class="content">
                                    <div class="name">
                                    ...
                                    <div class="cart-item-bot">
                                        <div class="text-button price">&pound;59.99</div>
                                    ...
                                    @for($i = 0; $i < 5; $i++)
                                        <div class="tf-mini-cart-item file-delete">
                                            <div class="tf-mini-cart-image">
                                                <img class="lazyload" data-src="{{ url('frontend/images/products/womens/women-19.jpg') }}" src="{{ url('frontend/images/products/womens/women-19.jpg') }}" alt="">
                                            </div>
                                            <div class="tf-mini-cart-info flex-grow-1">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-12">
                                                    ...
                                                    <div class="text-button">1 X &pound;60.00</div>
                                                </div>
                                            </div>
                                        </div>
                                    @endfor
                        ...
                        <div class="tf-mini-cart-bottom">
                            ...
                            <div class="tf-mini-cart-bottom-wrap">
                                <div class="tf-cart-totals-discounts">
                                    <h5>Subtotal</h5>
                                    <h5 class="tf-totals-total-value">&pound;186,99</h5>
                                </div>
                                ...
                                <div class="tf-mini-cart-tool-content">
                                    <div class="tf-mini-cart-tool-text">
                                        ...
                                        <div class="tf-gift-wrap-infos">
                                            ...
                                            Only
                                            <span class="price fw-6">&pound;5.00</span>
                                        </div>
                                    </div>
